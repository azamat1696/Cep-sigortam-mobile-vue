  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated reveal>
      <q-toolbar>
        ...
        <q-btn v-if="!isLogin" flat icon="menu" round size="lg" @click="toggleLeftDrawer"/>
        <q-btn v-if="isLogin" class="q-ml-md" color="grey-11" dense round size="md" text-color="black"
               unelevated @click="toggleLeftDrawer">
        ...
        <q-list padding>
          ...
          <q-item class="q-pa-none">
            ...
            <q-item-section avatar class="q-pl-sm">
              <q-btn class="text-subtitle2" rounded size="sm">TR</q-btn>
            </q-item-section>
            <q-item-section avatar class="q-pr-none">
              <q-btn class="text-subtitle2" color="primary" rounded size="sm" text-color="white">EN</q-btn>
            </q-item-section>
          </q-item>
          ...
          <div class="absolute-bottom">
            <q-item class="flex flex-center q-pb-none">
              ...
              <q-item-section class="text-end">

              </q-item-section>
            </q-item>
            <q-item class="flex flex-center q-pt-none">
              <q-item-section avatar class="items-end q-pr-sm">
                <q-img src="~assets/twitter.png" style="width: 29px"/>
              </q-item-section>
              <q-item-section avatar class="items-end q-pr-sm">
                <q-img src="~assets/linkdin.png" style="width: 29px"/>
              </q-item-section>
              <q-item-section avatar class="items-end q-pr-sm">
                <q-img src="~assets/facebook.png" style="width: 29px"/>
              </q-item-section>
              <q-item-section avatar class="items-end q-pr-sm">
                <q-img src="~assets/instagram.png" style="width: 29px"/>
              </q-item-section>
            </q-item>
          </div>
        </q-list>
