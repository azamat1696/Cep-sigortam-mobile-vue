   ...
   >
     <q-card-section class="q-pb-xs">
       <div class="text-center">
         <q-icon name="lock" class="bg-primary q-pa-lg" color="white" size="lg" style="border-radius:50%" />
       </div>
     </q-card-section>
     <q-card-section class="q-pt-xs">
       <q-form class="q-pt-md q-pb-md" @submit="onSubmit">
         <div class="text-subtitle1 q-pb-lg q-pl-md q-pr-md" style="color: #5E5E5E">
