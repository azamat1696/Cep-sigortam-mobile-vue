      ...
      >
        ...
        >
          <q-input
            ...
            hide-bottom-space
            lazy-rules
            :rules="[ val => val && val.length > 0 || 'Lutfen Motor cc Gücü giriniz']"
          />
          <q-input
            dense
            outlined
            ...
            hide-bottom-space
            lazy-rules
            :rules="[ val => val && val.length > 0 || 'Lutfen Araç Bedeli giriniz']"
          />
          <q-input
            dense
            outlined
            ...
            hide-bottom-space
            lazy-rules
            :rules="[ val => val && val.length > 0 || 'Lutfen Banka veya şube  giriniz']"
          />
          <q-input
            dense
            outlined
            ...
            hide-bottom-space
            lazy-rules
            :rules="[ val => val && val.length > 0 || 'Lutfen Motor No  giriniz']"
          />
          <q-input
            dense
            outlined
