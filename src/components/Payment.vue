<template>
                <q-form @submit="getTransaction" class="q-pt-lg full-height">
                    <div class="card-form">
                        <div class="card-list">
                            <div
                                class="card-item"
                        ...
                        <div class="card-form__inner">
                            <div class="card-input">
                                ...
                                <input
                                    ...
                                    v-maska
                                    :data-maska="generateCardNumberMask"
                                    v-model="cardNumber2"
                            ...
                            <button class="card-form__button" type="submit" >{{$t('finish_payment')}}</button>
                        </div>
                    </div>
                </q-form>
...
export default {
    ...
    setup() {
        ...
        return {
            currentCardBackground: ref(Math.floor(Math.random() * 25 + 1)), // just for fun :D
            cardName2: ref(""),
            cardNumber2: ref(""),
            cardMonth: ref(""),
            cardYear: ref(""),
            cardCvv: ref(""),
            minCardYear: ref(new Date().getFullYear()),
            amexCardMask: "#### ###### #####",
            otherCardMask: "#### #### #### ####",
            cardNumberTemp: ref(""),
            isCardFlipped: ref(false),
            focusElementStyle: ref(null),
    ...
    methods: {
        getTransaction() {
            this.$emit("getCardValues", this.cardNumber2, this.cardName2, this.cardMonth, this.cardYear, this.cardCvv);
        },
        flipCard(status) {
